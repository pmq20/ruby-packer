...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", ".travis.yml", "BSDL", "COPYING", "Gemfile", "LEGAL", "README.rdoc", "Rakefile", "benchmarks/bm_yhpg.rb", "benchmarks/helper.rb", "lib/power_assert.rb", "lib/power_assert/configuration.rb", "lib/power_assert/enable_tracepoint_events.rb", "lib/power_assert/version.rb", "power_assert.gemspec", "test/helper.rb", "test/test_power_assert.rb"]
