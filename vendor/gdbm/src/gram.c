...
static const yytype_uint16 yyrline[] =
{
      ...
      85,    95,    95,   108,   111,   114,   118,   125,   129,   135,
     141,   145,   153,   154,   161,   165,   171,   175,   183,   184,
     187,   187,   195,   199,   205,   206,   209,   224,   228,   236,
     240,   244,   249,   256,   260,   261,   264,   265,   268,   300,
     328,   329,   332
};
#endif
...
static const char *const yytname[] =
{
  ...
  "deflist", "def", "set", "asgnlist", "asgn", "varlist", "var", YY_NULL
};
#endif
...
#line 172 "gram.y"
    {
	      (yyval.slist).head = (yyval.slist).tail = slist_new_s ((yyvsp[(1) - (1)].string));
	    }
    break;
...
#line 176 "gram.y"
    {
	      struct slist *s = slist_new_s ((yyvsp[(3) - (3)].string));
	      slist_insert (&(yyvsp[(1) - (3)].slist).tail, s);
